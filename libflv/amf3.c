...
const uint8_t *AMF3ReadInteger_(const uint8_t *ptr, const uint8_t *end, int32_t *value)
{
	int i;
	int32_t v = 0;
...
const uint8_t *AMF3ReadString_(const uint8_t *ptr, const uint8_t *end, char *string, uint32_t *length)
{
	uint32_t v;
